...
| :--- | :--- | :--- |
| **Backend:** .NET Core, C#, Python (FastAPI) | **Orchestration:** CrewAI, Agents | **Tools:** Jira, Trello, Figma |
| **Frontend:** ReactJS, Angular, TypeScript | **DB:** MS SQL, MySQL, MongoDB | **Strategy:** PRDs, User Discovery |
| **Cloud:** Azure, CI/CD, Microservices | **AI Tools:** CursorAI, LLMs | **Leadership:** SSB Recommended (AFCAT/NDA) |
